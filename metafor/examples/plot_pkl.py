...
import pandas as pd
import csv 
pickle_files = ["discrete_results_multi_1.pkl","discrete_results_multi_2.pkl","discrete_results_multi_3.pkl","discrete_results_multi_4.pkl","discrete_results_multi_5.pkl"]  # can be one or multiple files
...
figure_name = 'plot_latency_multi.png'
...
figure_name = 'plot_qlen_multi.png'
time = [i * step_time for i in list(range(0, len(qlen_ave)))]
# Create 4x1 sub plots
#plt.rcParams["figure.figsize"] = [6, 10]
plt.rcParams["figure.autolayout"] = True
