...
def average_lengths_analysis(ctmc: SingleServerCTMC, file_name: str, plot_params: PlotParameters):
    ...
    plot_results(plot_params.step_time, main_queue_avg_len, main_queue_var_len, main_queue_std_len, runtime, file_name)
...
def fault_scenario_analysis(ctmc: SingleServerCTMC, file_name: str, plot_params: PlotParameters):
    ...
    fault_scenario_plot_generator("mu", lambda_fault, start_time_fault, duration_fault, mu_min, mu_max,
                                  mu_step, main_queue_size, retry_queue_size, lambdaas, mu0_ps, timeouts,
                                  retries, thread_pool, alpha, 10, file_name)
    fault_scenario_plot_generator("to", lambda_fault, start_time_fault, duration_fault, timeout_min,
                                  timeout_max, 1, main_queue_size, retry_queue_size, lambdaas, mu0_ps,
                                  timeouts, retries, thread_pool, alpha, 9, file_name)
    fault_scenario_plot_generator("lambda", lambda_fault, start_time_fault, duration_fault, reset_lambda_min,
...
def latency_analysis(ctmc: SingleServerCTMC, file_name: str, plot_params: PlotParameters, job_type: int = -1):
    job_details = ''
    if job_type != -1:
    ...
    latency_plot_generator("to", timeout_min, timeout_max, 1, main_queue_size, retry_queue_size, lambdaas,
                           mu0_ps, timeouts, retries, thread_pool, alpha, file_name, job_type)
    print('For the processing rate')
    latency_plot_generator("mu", mu_min, mu_max, mu_step, main_queue_size, retry_queue_size, lambdaas, mu0_ps,
                           timeouts, retries, thread_pool, alpha, file_name, job_type)
    print('For the arrival rate')
    latency_plot_generator("lambda", lambda_min, lambda_max, lambda_step, main_queue_size, retry_queue_size,
                           lambdaas, mu0_ps, timeouts, retries, thread_pool, alpha, file_name, job_type)
    print('For the main queue length')
    latency_plot_generator("qlen", 80, qlen_max, qlen_step, main_queue_size, retry_queue_size, lambdaas,
                           mu0_ps, timeouts, retries, thread_pool, alpha, file_name, job_type)
    print('For the orbit length')
    latency_plot_generator("olen", 10, olen_max, olen_step, main_queue_size, retry_queue_size, lambdaas,
                           mu0_ps, timeouts, retries, thread_pool, alpha, file_name, job_type)

    # M/M/1 plots
    print('Creating the latency M/M/1 plots')
    print('For the processing rate')
    latency_plot_generator("mu", mu_min, mu_max, mu_step, main_queue_size, 1, lambdaas, mu0_ps, timeouts,
                           retries, thread_pool, alpha, file_name, job_type)
    print('For the arrival rate')
    latency_plot_generator("lambda", lambda_min, lambda_max, lambda_step, main_queue_size, 1, lambdaas, mu0_ps,
                           timeouts, retries, thread_pool, alpha, file_name, job_type)
